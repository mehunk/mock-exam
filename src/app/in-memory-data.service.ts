...
export class InMemoryDataService implements InMemoryDbService {
  createDb () {
    ...
    {
        'id': 3,
        'questionText': 'Which of the following function of String object returns'
          + 'the index within the calling String object of the first occurrence of the specified value?',
        'answers': [
          {'id': 1,
    ...
    return { categories, questions, tags };
  }
}
